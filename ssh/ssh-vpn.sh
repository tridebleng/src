...
curl -sS https://raw.githubusercontent.com/tridebleng/src/ipuk/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/tridebleng/src/ipuk/ssh/nginx.conf"
mkdir -p /home/vps/public_html
/etc/init.d/nginx restart

# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/tridebleng/src/ipuk/ssh/newudpgw"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/tridebleng/src/ipuk/issue.net"
...
wget https://raw.githubusercontent.com/tridebleng/src/ipuk/ssh/bbr.sh && chmod +x bbr.sh && ./bbr.sh
...
# download script
cd /usr/bin
wget -O usernew "https://raw.githubusercontent.com/tridebleng/src/ipuk/ssh/usernew.sh"
wget -O hapus "https://raw.githubusercontent.com/tridebleng/src/ipuk/ssh/hapus.sh"
wget -O member "https://raw.githubusercontent.com/tridebleng/src/ipuk/ssh/member.sh"
wget -O renew "https://raw.githubusercontent.com/tridebleng/src/ipuk/ssh/renew.sh"
wget -O cek "https://raw.githubusercontent.com/tridebleng/src/ipuk/ssh/cek.sh"
wget -O add-host "https://raw.githubusercontent.com/tridebleng/src/ipuk/ssh/add-host.sh"
wget -O speedtest "https://raw.githubusercontent.com/tridebleng/src/ipuk/ssh/speedtest_cli.py"
wget -O xp "https://raw.githubusercontent.com/tridebleng/src/ipuk/ssh/xp.sh"
...
wget -O ceklim "https://raw.githubusercontent.com/tridebleng/src/ipuk/ssh/ceklim.sh"
...
wget -O cek-user "https://raw.githubusercontent.com/tridebleng/src/ipuk/dll/cek-user.sh"
chmod +x usernew
chmod +x menu
chmod +x hapus
chmod +x member
